    ...
    public class Connection
    {
        ...
        public void SetAndClearPolicy(Controller.PolicyFlag set, Controller.PolicyFlag clear, Device device = null)
        {
            ...
            else
            {
                ...
                {
                    Console.WriteLine(String.Format("Your current tracking service does not support setting policy flags on a per device basis (min version is {0}.{1}.{2}). Please update your service: https://developer.leapmotion.com/tracking-software-download",
        ...
        public void ClearPolicy(Controller.PolicyFlag policy, Device device = null)
        {
            ...
            else
            {
                if (!Controller.CheckRequiredServiceVersion(MinServiceVersionForMultiModeSupport, this))
                {
                    Console.WriteLine(String.Format("Your current tracking service does not support clearing policy flags on a per device basis (min version is {0}.{1}.{2}). Please update your service: https://developer.leapmotion.com/tracking-software-download",
                        MinServiceVersionForMultiModeSupport.major,
                        MinServiceVersionForMultiModeSupport.minor,
                        MinServiceVersionForMultiModeSupport.patch));
