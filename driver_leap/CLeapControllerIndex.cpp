...
vr::EVRInitError CLeapControllerIndex::Activate(uint32_t unObjectId)
{
    ...
    if(m_trackedDevice == vr::k_unTrackedDeviceIndexInvalid)
    {
        ...
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_ModelNumber_String, (m_controllerHand == CH_Left) ? "Knuckles Left" : "Knuckles Right");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_RenderModelName_String, (m_controllerHand == CH_Left) ? "{indexcontroller}valve_controller_knu_1_0_left" : "{indexcontroller}valve_controller_knu_1_0_right");
        ...
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_Firmware_ProgrammingTarget_String, (m_controllerHand == CH_Left) ? "LHR-E217CD00" : "LHR-E217CD01"); // Changed
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_ResourceRoot_String, "indexcontroller");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_RegisteredDeviceType_String, (m_controllerHand == CH_Left) ? "valve/index_controllerLHR-E217CD00" : "valve/index_controllerLHR-E217CD01"); // Changed
        ...
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceOff_String, (m_controllerHand == CH_Left) ? "{indexcontroller}/icons/left_controller_status_off.png" : "{indexcontroller}/icons/right_controller_status_off.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceSearching_String, (m_controllerHand == CH_Left) ? "{indexcontroller}/icons/left_controller_status_searching.gif" : "{indexcontroller}/icons/right_controller_status_searching.gif");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceSearchingAlert_String, (m_controllerHand == CH_Left) ? "{indexcontroller}/icons/left_controller_status_searching_alert.gif" : "{indexcontroller}/icons//right_controller_status_searching_alert.gif");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceReady_String, (m_controllerHand == CH_Left) ? "{indexcontroller}/icons/left_controller_status_ready.png" : "{indexcontroller}/icons//right_controller_status_ready.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceReadyAlert_String, (m_controllerHand == CH_Left) ? "{indexcontroller}/icons/left_controller_status_ready_alert.png" : "{indexcontroller}/icons//right_controller_status_ready_alert.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceNotReady_String, (m_controllerHand == CH_Left) ? "{indexcontroller}/icons/left_controller_status_error.png" : "{indexcontroller}/icons//right_controller_status_error.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceStandby_String, (m_controllerHand == CH_Left) ? "{indexcontroller}/icons/left_controller_status_off.png" : "{indexcontroller}/icons//right_controller_status_off.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceAlertLow_String, (m_controllerHand == CH_Left) ? "{indexcontroller}/icons/left_controller_status_ready_low.png" : "{indexcontroller}/icons//right_controller_status_ready_low.png");
    ...
    if(CGestureMatcher::GetGestures(f_frame, ((m_controllerHand == CH_Left) ? CGestureMatcher::GH_LeftHand : CGestureMatcher::GH_RightHand), l_scores))
    {
            ...
            case GP_Default:
            {
                if(CDriverConfig::IsInputEnabled())
                {
                    ...
                    if(CDriverConfig::IsThumbstickEnabled())
                    {
                        ...
                        {
                            if(GetAsyncKeyState((m_controllerHand == CH_Left) ? VK_RIGHT : VK_NUMPAD6) & 0x8000) m_buttons[IB_ThumbstickX]->SetValue(1.f);
                            else if(GetAsyncKeyState((m_controllerHand == CH_Left) ? VK_LEFT : VK_NUMPAD4) & 0x8000) m_buttons[IB_ThumbstickX]->SetValue(-1.f);
                            else m_buttons[IB_ThumbstickX]->SetValue(0.f);

                            if(GetAsyncKeyState((m_controllerHand == CH_Left) ? VK_UP : VK_NUMPAD8) & 0x8000) m_buttons[IB_ThumbstickY]->SetValue(1.f);
                            else if(GetAsyncKeyState((m_controllerHand == CH_Left) ? VK_DOWN : VK_NUMPAD2) & 0x8000) m_buttons[IB_ThumbstickY]->SetValue(-1.f);
        ...
        if(CDriverConfig::IsSkeletonEnabled())
        {
            ...
            for(Leap::Hand l_hand : f_frame.hands())
            {
                if(l_hand.isValid())
                {
                    if((l_hand.isLeft() && (m_controllerHand == CH_Left)) || (l_hand.isRight() && (m_controllerHand == CH_Right)))
                    {
                        // Update rotations
                        glm::mat4 l_handMat;
                        ...
                        for(Leap::Finger l_finger : l_hand.fingers())
                        {
                            if(l_finger.isValid())
                            {
                                ...
                                {
                                    if(m_controllerHand == CH_Left) l_result = glm::rotate(l_result, glm::pi<float>(), g_axisX);
                                    else
                                    {
                                        l_result.w *= -1.f;
                                        l_result.z *= -1.f;
                        ...
                        if(m_controllerHand == CH_Left) FixAuxBoneTransformation(l_position, l_rotation);
