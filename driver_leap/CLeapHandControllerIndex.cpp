...
CLeapHandControllerIndex::CLeapHandControllerIndex(unsigned char f_hand)
{
...
CLeapHandControllerIndex::~CLeapHandControllerIndex()
{
}

vr::EVRInitError CLeapHandControllerIndex::Activate(uint32_t unObjectId)
{
    ...
    if(m_trackedDeviceID == vr::k_unTrackedDeviceIndexInvalid)
    {
        ...
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_ModelNumber_String, (m_handAssigment == CHA_Left) ? "Knuckles Left" : "Knuckles Right");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_RenderModelName_String, (m_handAssigment == CHA_Left) ? "{indexcontroller}valve_controller_knu_1_0_left" : "{indexcontroller}valve_controller_knu_1_0_right");
        ...
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_Firmware_ProgrammingTarget_String, (m_handAssigment == CHA_Left) ? "LHR-E217CD00" : "LHR-E217CD01"); // Changed
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_ResourceRoot_String, "indexcontroller");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_RegisteredDeviceType_String, (m_handAssigment == CHA_Left) ? "valve/index_controllerLHR-E217CD00" : "valve/index_controllerLHR-E217CD01"); // Changed
        ...
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceOff_String, (m_handAssigment == CHA_Left) ? "{indexcontroller}/icons/left_controller_status_off.png" : "{indexcontroller}/icons/right_controller_status_off.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceSearching_String, (m_handAssigment == CHA_Left) ? "{indexcontroller}/icons/left_controller_status_searching.gif" : "{indexcontroller}/icons/right_controller_status_searching.gif");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceSearchingAlert_String, (m_handAssigment == CHA_Left) ? "{indexcontroller}/icons/left_controller_status_searching_alert.gif" : "{indexcontroller}/icons//right_controller_status_searching_alert.gif");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceReady_String, (m_handAssigment == CHA_Left) ? "{indexcontroller}/icons/left_controller_status_ready.png" : "{indexcontroller}/icons//right_controller_status_ready.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceReadyAlert_String, (m_handAssigment == CHA_Left) ? "{indexcontroller}/icons/left_controller_status_ready_alert.png" : "{indexcontroller}/icons//right_controller_status_ready_alert.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceNotReady_String, (m_handAssigment == CHA_Left) ? "{indexcontroller}/icons/left_controller_status_error.png" : "{indexcontroller}/icons//right_controller_status_error.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceStandby_String, (m_handAssigment == CHA_Left) ? "{indexcontroller}/icons/left_controller_status_off.png" : "{indexcontroller}/icons//right_controller_status_off.png");
        ms_propertyHelpers->SetStringProperty(m_propertyContainer, vr::Prop_NamedIconPathDeviceAlertLow_String, (m_handAssigment == CHA_Left) ? "{indexcontroller}/icons/left_controller_status_ready_low.png" : "{indexcontroller}/icons//right_controller_status_ready_low.png");
        ...
        m_buttons[IB_TriggerValue]->SetInputType(CControllerButton::CBIT_Float);
        ...
        m_buttons[IB_TrackpadX]->SetInputType(CControllerButton::CBIT_Float);
        ...
        m_buttons[IB_TrackpadY]->SetInputType(CControllerButton::CBIT_Float);

        ms_driverInput->CreateBooleanComponent(m_propertyContainer, "/input/trackpad/touch", &m_buttons[IB_TrackpadTouch]->GetHandleRef());
        m_buttons[IB_TrackpadTouch]->SetInputType(CControllerButton::CBIT_Boolean);
        ...
        m_buttons[IB_TrackpadForce]->SetInputType(CControllerButton::CBIT_Float);

        ms_driverInput->CreateBooleanComponent(m_propertyContainer, "/input/grip/touch", &m_buttons[IB_GripTouch]->GetHandleRef());
        m_buttons[IB_GripTouch]->SetInputType(CControllerButton::CBIT_Boolean);
        ...
        m_buttons[IB_GripForce]->SetInputType(CControllerButton::CBIT_Float);
        ...
        m_buttons[IB_GripValue]->SetInputType(CControllerButton::CBIT_Float);
        ...
        m_buttons[IB_ThumbstickClick]->SetInputType(CControllerButton::CBIT_Boolean);
        ...
        m_buttons[IB_ThumbstickTouch]->SetInputType(CControllerButton::CBIT_Boolean);
        ...
        m_buttons[IB_ThumbstickX]->SetInputType(CControllerButton::CBIT_Float);
        ...
        m_buttons[IB_FingerIndex]->SetInputType(CControllerButton::CBIT_Float);
        ...
        m_buttons[IB_FingerMiddle]->SetInputType(CControllerButton::CBIT_Float);
        ...
        m_buttons[IB_FingerRing]->SetInputType(CControllerButton::CBIT_Float);
        ...
        m_buttons[IB_FingerPinky]->SetInputType(CControllerButton::CBIT_Float);
...
void CLeapHandControllerIndex::UpdateGestures(const Leap::Frame &f_frame)
{
            ...
            case GP_Default:
            {
                if(CDriverConfig::IsInputEnabled())
                {
                    ...
                    if(CDriverConfig::IsThumbstickEnabled())
                    {
                        ...
                        {
                            if(GetAsyncKeyState((m_handAssigment == CHA_Left) ? VK_RIGHT : VK_NUMPAD6) & 0x8000) m_buttons[IB_ThumbstickX]->SetValue(1.f);
                            else if(GetAsyncKeyState((m_handAssigment == CHA_Left) ? VK_LEFT : VK_NUMPAD4) & 0x8000) m_buttons[IB_ThumbstickX]->SetValue(-1.f);
                            else m_buttons[IB_ThumbstickX]->SetValue(0.f);

                            if(GetAsyncKeyState((m_handAssigment == CHA_Left) ? VK_UP : VK_NUMPAD8) & 0x8000) m_buttons[IB_ThumbstickY]->SetValue(1.f);
                            else if(GetAsyncKeyState((m_handAssigment == CHA_Left) ? VK_DOWN : VK_NUMPAD2) & 0x8000) m_buttons[IB_ThumbstickY]->SetValue(-1.f);
...
void CLeapHandControllerIndex::UpdateInputInternal()
{
...
bool CLeapHandControllerIndex::MixHandState(bool f_state)
{
